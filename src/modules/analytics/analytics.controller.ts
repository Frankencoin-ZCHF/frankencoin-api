...
export class AnalyticsController {
				...
				logs: {
					...
					items: {
						...
						properties: {
							...
							totalSavings: { type: 'string', description: 'Total savings balance (in wei)' },
				...
				logs: [
					{
						...
						totalSavings: '892411356098117235461104',
	...
	@ApiResponse({
		...
		schema: {
			type: 'string',
			example:
				'timestamp, kind, amount, totalInflow, totalOutflow, totalEquity, totalSavings, fpsTotalSupply, fpsPrice, realizedNetEarnings, earningsPerFPS \n' +
				'1769349443, Savings:Withdrawn, 11114.190782590627133232, 1136590.707253052819761165, 44481.533249377602588670, 3568161.467526286248560062, 892411.356098117235461104, 8762.117095160688215312, 1221.677853231491140185, 490706.084649344763179171, 125.651799497032985606',
		},
	})
	...
	@ApiResponse({
		...
		schema: {
			type: 'string',
			example:
				'date, timestamp, totalInflow, totalOutflow, totalEquity, totalSavings, fpsTotalSupply, fpsPrice, realizedNetEarnings, earningsPerFPS \n' +
				'2026-01-25, 1769299200000, 1136590.707253052819761165, 44481.533249377602588670, 3568161.467526286248560062, 892411.356098117235461104, 8762.117095160688215312, 1221.677853231491140185, 490706.084649344763179171, 125.651799497032985606',
		},
	})
